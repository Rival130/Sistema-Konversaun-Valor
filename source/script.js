...
document.getElementById("konv-btn").addEventListener("click", function () {
    const inputValue = document.getElementById("input-text").value;
    const gradeValue = calculateGrade(inputValue);
    document.getElementById("output-text").value = gradeValue;
    document.getElementById("output-label").textContent = "Grade :";
});
